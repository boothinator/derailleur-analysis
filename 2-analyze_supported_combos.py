...
graph_combos("dynasys_", [c for c in supported_combos if "Deore" in c["shifter"]["name"] and c["derailleur"]["pullRatio"] < 1.15])
graph_combos("dynasys_like_", [c for c in supported_combos if c["derailleur"]["pullRatio"] < 1.15])
